<template>
    <div 
        class="bg-[url('assets/imgs/bg.jpg')] bg-cover bg-center
    ...
    >
        ...
        <div class="flex-1 mr-5 bg-opacity-50 bg-slate-800 p-3flex flex-col">
            <!-- 横向柱状图 -->
			<HorizontaBar class="h-1/3 box-border pb-4" :data="data.regionData" />
            <!-- 雷达图 -->
        ...
        <!-- 右 -->
        <div class="flex-1 bg-opacity-50 bg-slate-800
        p-3flex flex-col">
            <!-- 竖向柱状图 -->
...
import HorizontaBar from './components/HorizontaBar.vue'
